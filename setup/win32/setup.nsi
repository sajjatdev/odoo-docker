...
!define PUBLISHER 'Qplexity Solutions'
...
!define UNINSTALL_REGISTRY_KEY_SERVER "${UNINSTALL_BASE_REGISTRY_KEY}\Qplexity Server ${VERSION}"
...
!define MUI_FINISHPAGE_LINK_LOCATION "https://www.Qplexity.com/page/contactus"
...
; English
LangString DESC_Qplexity_Server ${LANG_ENGLISH} "Install the Qplexity Server with all the Qplexity standard modules."
LangString DESC_PostgreSQL ${LANG_ENGLISH} "Install the PostgreSQL RDBMS used by Qplexity."
LangString DESC_FinishPage_Link ${LANG_ENGLISH} "Contact Qplexity for Partnership and/or Support"
LangString DESC_AtLeastOneComponent ${LANG_ENGLISH} "You have to choose at least one component"
LangString DESC_CanNotInstallPostgreSQL ${LANG_ENGLISH} "You can not install the PostgreSQL database without the Qplexity Server"
...
LangString Profile_AllInOne ${LANG_ENGLISH} "Qplexity Server And PostgreSQL Server"
LangString Profile_Server ${LANG_ENGLISH} "Qplexity Server Only"
LangString Profile_IOT ${LANG_ENGLISH} "Qplexity IoT"
LangString TITLE_Qplexity_Server ${LANG_ENGLISH} "Qplexity Server"
LangString TITLE_PostgreSQL ${LANG_ENGLISH} "PostgreSQL Database"
LangString TITLE_IOT ${LANG_ENGLISH} "Qplexity IoT"
LangString TITLE_Nginx ${LANG_ENGLISH} "Nginx WebServer"
LangString TITLE_Ghostscript ${LANG_ENGLISH} "Ghostscript interpreter"
LangString DESC_FinishPageText ${LANG_ENGLISH} "Start Qplexity"
LangString UnsafeDirText ${LANG_ENGLISH} "Installing outside of $PROGRAMFILES64 is not recommended.$\nDo you want to continue ?"

; French
LangString DESC_Qplexity_Server ${LANG_FRENCH} "Installation du Serveur Qplexity avec tous les modules Qplexity standards."
LangString DESC_PostgreSQL ${LANG_FRENCH} "Installation de la base de données PostgreSQL utilisée par Qplexity."
LangString DESC_FinishPage_Link ${LANG_FRENCH} "Contactez Qplexity pour un Partenariat et/ou du Support"
LangString DESC_AtLeastOneComponent ${LANG_FRENCH} "Vous devez choisir au moins un composant"
LangString DESC_CanNotInstallPostgreSQL ${LANG_FRENCH} "Vous ne pouvez pas installer la base de données PostgreSQL sans le serveur Qplexity"
...
LangString Profile_AllInOne ${LANG_FRENCH} "Serveur Qplexity Et Serveur PostgreSQL"
LangString Profile_Server ${LANG_FRENCH} "Seulement Le Serveur Qplexity"
LangString Profile_IOT ${LANG_FRENCH} "Qplexity IoT"
LangString TITLE_Qplexity_Server ${LANG_FRENCH} "Serveur Qplexity"
LangString TITLE_PostgreSQL ${LANG_FRENCH} "Installation du serveur de base de données PostgreSQL"
LangString TITLE_IOT ${LANG_FRENCH} "Qplexity IoT"
...
LangString DESC_FinishPageText ${LANG_FRENCH} "Démarrer Qplexity"
...
Section $(TITLE_Qplexity_Server) SectionQplexity_Server
    SectionIn 1 2 3
    ...
    # If there is a previous install of the Qplexity Server, keep the login/password from the config file
...
Section $(TITLE_PostgreSQL) SectionPostgreSQL
    ...
    ExecWait '"$TEMP\$postgresql_exe_filename" \
        ...
        --servicename "PostgreSQL_For_Qplexity" \
...
Section -Post
    ...
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "HelpLink" "support@Qplexity.com"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "HelpTelephone" "+32.81.81.37.00"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "URLInfoAbout" "https://www.Qplexity.com"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "Contact" "sales@Qplexity.com"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
    !insertmacro MUI_DESCRIPTION_TEXT ${SectionQplexity_Server} $(DESC_Qplexity_Server)
...
Function .onInit
    ...
    ${If} $previous_install_dir == ""
        StrCpy $INSTDIR "$PROGRAMFILES64\Qplexity ${VERSION}"
...
Function ShowProxyTokenDialogPage
    ...
    doProxyToken:
        ...
        ${NSD_CreateLabel} 0 0 100% 25% "Here is your access token for the Qplexity IOT, please write it down in a safe place, you will need it to configure the IOT"
        Pop $ProxyTokenLabel
...
Function ComponentLeave
    SectionGetFlags ${SectionQplexity_Server} $0
...
Function RestartQplexityService
    DetailPrint "Restarting Qplexity Service"
