...
Prefix: %{_prefix}
BuildArch: noarch
Vendor: Qplexity Solutions <info@Qplexity.com>
Requires: sassc
BuildRequires: python3-devel
BuildRequires: pyproject-rpm-macros
Url: https://www.Qplexity.com

%description
Qplexity is a complete ERP and CRM. The main features are accounting (analytic
...
cat << EOF > $INIT_FILE
[Unit]
Description=Qplexity Open Source ERP and CRM
