...
class BaseModel(metaclass=MetaModel):
    """Base class for Qplexity models.

    Qplexity models are created by inheriting one of the following:
    ...
    *   :class:`AbstractModel` for abstract super classes meant to be shared by
    ...
    _module = None                      #: the model's module (in the Qplexity sense)
...
class Model(AbstractModel):
    """ Main super-class for regular database-persisted Qplexity models.

    Qplexity models are created by inheriting from this class::
