...
class configmanager(object):
    def __init__(self, fname=None):
        ...
        self.options = {
            'admin_passwd': 'admin',
            'csv_internal_sep': ',',
            'publisher_warranty_url': 'http://services.Qplexity.com/publisher-warranty/',
            'reportgz': False,
            'root_path': None,
        ...
        group.add_option("-D", "--data-dir", dest="data_dir", my_default=_get_default_datadir(),
                         help="Directory where to store Qplexity data")
        ...
        group = optparse.OptionGroup(parser, "Internationalisation options",
            "Use these options to translate Qplexity to another language. "
    ...
    def parse_config(self, args: list[str] | None = None, *, setup_logging: bool | None = None) -> None:
        ...
        if setup_logging is not False:
            ...
            if setup_logging is None:
                warnings.warn(
                    "As of Qplexity 18, it's recommended to specify whether"
                    " you want Qplexity to setup its own logging (or want to"
                    " handle it yourself)",
