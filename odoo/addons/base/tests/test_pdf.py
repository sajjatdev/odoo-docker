...
class TestPdf(TransactionCase):
    ...
    def setUp(self):
        ...
        self.minimal_pdf_reader = pdf.QplexityPdfFileReader(self.minimal_reader_buffer)
    ...
    def test_odoo_pdf_file_reader(self):
        ...
        r = pdf.QplexityPdfFileReader(io.BytesIO(out.getvalue()))
    ...
    def test_odoo_pdf_file_writer(self):
        ...
        for count, (name, data) in enumerate([
            ...
            pdf_writer = pdf.QplexityPdfFileWriter()
    ...
    def test_odoo_pdf_file_reader_with_owner_encryption(self):
        ...
        with io.BytesIO(encrypted_content) as reader_buffer:
            pdf_reader = pdf.QplexityPdfFileReader(reader_buffer)
    ...
    def test_merge_pdf(self):
        ...
        merged_pdf_reader = pdf.QplexityPdfFileReader(merged_reader_buffer)
    ...
    def test_branded_file_writer(self):
        ...
        self.assertEqual(pdf_info['/Producer'], 'Qplexity')
        self.assertEqual(pdf_info['/Creator'], 'Qplexity')
        reader_buffer.close()
