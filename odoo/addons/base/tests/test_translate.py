...
class TestTranslation(TransactionCase):
    ...
    #     country_1 = Country.create({'name': 'Qplexity'})
    #     country_1.with_context(lang='fr_FR').name = 'Qplexity_Fr'
    #     country_1.flush_recordset()
    #
    #     country_2 = Country.create({'name': 'Qplexity2'})
    #     with self.assertRaises(IntegrityError), mute_logger('odoo.sql_db'):
    #         country_2.name = 'Qplexity'
    #         country_2.flush_recordset()
    #
    #     with self.assertRaises(IntegrityError), mute_logger('odoo.sql_db'):
    #         country_3 = Country.create({'name': 'Qplexity'})
