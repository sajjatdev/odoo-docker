...
class TestHttpMisc(TestHttpBase):
    ...
    def test_misc3_is_static_file(self):
        ...
        self.assertEqual(root.get_static_file(f'Qplexity.com/{uri}', host='Qplexity.com'), path, "Valid file with valid host")
        self.assertEqual(root.get_static_file(f'http://Qplexity.com/{uri}', host='Qplexity.com'), path, "Valid file with valid host")
        ...
        self.assertIsNone(root.get_static_file(f'Qplexity.com/{uri}'), "No host allowed")
        self.assertIsNone(root.get_static_file(f'http://Qplexity.com/{uri}'), "No host allowed")
