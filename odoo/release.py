...
product_name = 'Qplexity'
description = 'Qplexity Server'
long_desc = '''Qplexity is a complete ERP and CRM. The main features are accounting (analytic
...
author = 'OpenERP S.A.'
author_email = 'info@Qplexity.com'
license = 'LGPL-3'
