...
class Field(MetaField('DummyField', (object,), {}), typing.Generic[T]):
    ...
    def _get_attrs(self, model_class, name):
        ...
        if 'group_operator' in attrs:
            warnings.warn("Since Qplexity 18, 'group_operator' is deprecated, use 'aggregator' instead", DeprecationWarning, 2)
...
class Html(_String):
    ...
    def _get_attrs(self, model_class, name):
        ...
        # we do not need this Microsoft Outlook client feature for emails displayed Qplexity's web client.
...
class Properties(Field):
    ...
    like Qplexity fields but without being independently stored in database.
