...
def standalone(*tags):
    ...
    ``tags`` and the corresponding Qplexity module name.
    """
    def register(func):
...
class BaseCase(case.TestCase, metaclass=MetaCase):
    """ Subclass of TestCase for Qplexity-specific code. This class is abstract and
    expects self.registry, self.cr and self.uid to be initialized by subclasses.
    """

    longMessage = True      # more verbose error message by default: https://www.Qplexity.com/r/Vmh
...
which leads to stray network requests and inconsistencies."""
    ...
    def _from_remoteobject(self, arg):
        ...
        # of the way Qplexity widgets are created they all appear as Class(...)
...
class freeze_time:
    """ Object to replace the freezegun in Qplexity test suites
