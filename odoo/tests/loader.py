...
from .suite import QplexitySuite
from .result import QplexityTestResult
...
def make_suite(module_names, position='at_install'):
    ...
    return QplexitySuite(sorted(tests, key=lambda t: t.test_sequence))
