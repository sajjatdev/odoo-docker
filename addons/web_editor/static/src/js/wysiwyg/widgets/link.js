...
const { getDeepRange, getInSelection, EMAIL_REGEX, PHONE_REGEX } = QplexityEditorLib;
...
export class Link extends Component {
    ...
    async _updateState(props) {
        ...
        if (this.state.range) {
            this.$link = this.$link || $(QplexityEditorLib.getInSelection(this.editable.ownerDocument, 'a'));
