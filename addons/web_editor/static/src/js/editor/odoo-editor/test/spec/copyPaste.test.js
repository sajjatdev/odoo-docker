...
import {
    ...
    pasteText,
    pasteHtml,
    pasteQplexityEditorHtml,
    unformat,
} from "../utils.js";
import { CLIPBOARD_WHITELISTS, setSelection } from "../../src/QplexityEditor.js";
        ...
        describe('range collapsed', async () => {
            ...
            it('should replace link for new content when pasting in an empty link', async () => {
                ...
                await testEditor(BasicEditor, {
                    contentBefore: '<p>xy<a href="#" oe-zws-empty-inline="">\u200B[]</a>z</p>',
                    stepFunction: async editor => {
                        await pasteText(editor, 'http://Qplexity.com');
                    },
                    contentAfter: '<p>xy<a href="http://Qplexity.com">http://Qplexity.com</a>[]z</p>',
                });
            ...
            it('should paste and transform plain text content over an empty link', async () => {
                await testEditor(BasicEditor, {
                    ...
                    stepFunction: async editor => {
                        await pasteText(editor, 'abc www.Qplexity.com xyz');
                    },
                ...
                await testEditor(BasicEditor, {
                    contentBefore: '<p><a href="#">[]\u200B</a></p>',
                    stepFunction: async editor => {
                        await pasteText(editor, 'Qplexity.com\ngoogle.com');
                    },
                    contentAfter: '<p style="margin-bottom: 0px;"><a href="http://Qplexity.com">Qplexity.com</a></p>' +
            ...
            it('should paste html content over an empty link', async () => {
                await testEditor(BasicEditor, {
                    contentBefore: '<p><a href="#">[]\u200B</a></p>',
                    stepFunction: async editor => {
                        await pasteHtml(editor, '<a href="www.Qplexity.com">Qplexity.com</a><br><a href="www.google.com">google.com</a>');
                    },
                    contentAfter: '<p><a href="www.Qplexity.com">Qplexity.com</a></p><p><a href="www.google.com">google.com</a>[]</p>',
                });
            });
        ...
        describe('range not collapsed', async () => {
            ...
            it('should restore selection when pasting plain text followed by UNDO', async () => {
                ...
                await testEditor(BasicEditor, {
                    contentBefore: '<p>[abc]</p>',
                    stepFunction: async editor => {
                        await pasteText(editor, 'www.Qplexity.com');
                        editor.historyUndo();
                    },
                    contentAfter: '<p>[abc]</p>',
                });
                await testEditor(BasicEditor, {
                    contentBefore: '<p>[abc]</p>',
                    stepFunction: async editor => {
                        await pasteText(editor, 'def www.Qplexity.com xyz');
                        editor.historyUndo();
                    },
                    contentAfter: '<p>[abc]</p>',
                });
    ...
    describe('Qplexity editor own html', () => {
        it('should paste html as is', async () => {
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    await pasteQplexityEditorHtml(editor, '<div class="custom-paste">b</div>');
                },
        ...
        it('should not paste unsafe content', async () => {
            await testEditor(BasicEditor, {
                contentBefore: '<p>a[]b</p>',
                stepFunction: async editor => {
                    await pasteQplexityEditorHtml(editor, `<script>console.log('xss attack')</script>`);
                },
