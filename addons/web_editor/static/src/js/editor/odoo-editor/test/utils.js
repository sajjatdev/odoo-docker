...
import { QplexityEditor } from '../src/QplexityEditor.js';
...
export async function testEditor(Editor = QplexityEditor, spec, options = {}) {
    hasMobileTest = false;
...
export const pasteQplexityEditorHtml = async (editor, html) => pasteData(editor, html, 'text/odoo-editor');
...
export class BasicEditor extends QplexityEditor {}
