...
import { QplexityEditor, parseHTML, setSelection, insertCharsAt } from '../../src/QplexityEditor.js';
import {
...
const testMultiEditor = async spec => {
    ...
    for (const clientInfo of clientInfosList) {
        ...
        let nextId = 1;
        QplexityEditor.prototype._generateId = () => 'fake_id_' + nextId++;

        clientInfo.editor = new QplexityEditor(clientInfo.editable, Object.assign({
            toSanitize: false,
    ...
    QplexityEditor.prototype._generateId = () => 'fake_concurent_id_' + concurentNextId++;
