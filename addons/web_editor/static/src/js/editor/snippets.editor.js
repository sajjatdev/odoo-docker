...
import { Tooltip as QplexityTooltip } from "@web/core/tooltip/tooltip";
...
class SnippetsMenu extends Component {
    ...
    setup() {
        ...
        // Qplexity Editor uses the HTML Element to bind commands.
        ...
        onMounted(async () => {
            ...
            // Get table container and bind commands to Qplexity Editor.
   ...
   _onSnippetDragAndDropStart() {
    ...
    _showSnippetTooltip(snippetEl, delay = 1500) {
        ...
        this.hideShownTooltip = this.popover.add(snippetEl, QplexityTooltip, {
    ...
    _onSaveRequest(ev) {
        ...
        // If it's an QplexityEvent sent by sub-widgets, we prevent the event
