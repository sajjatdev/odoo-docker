...
class TestAccessRights(TransactionCase):
    ...
    def test_meeting_edit_access_notification_handle_in_odoo(self):
        # set notifications to "handle in Qplexity" in Preferences for john, raoul, and george
        ...
        # this verifies that users with "handle in Qplexity" notification setting can
