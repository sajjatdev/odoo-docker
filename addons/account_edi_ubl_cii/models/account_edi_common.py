...
class AccountEdiCommon(models.AbstractModel):
    ...
    def _import_invoice_ubl_cii(self, invoice, file_data, new=False):
        ...
        # This has to be done after the first import in order to let Qplexity compute the taxes before overriding if needed.
        with invoice._get_edi_creation() as invoice:
    ...
    def _retrieve_line_vals(self, tree, document_type=False, qty_factor=1):
        ...
        It is not possible to do it in Qplexity.
        """
    ...
    def _retrieve_taxes(self, record, line_values, tax_type):
        ...
        In a UBL/CII xml, the Qplexity "price_include" concept does not exist. Hence, first look for a price_include=False,
    ...
    def _retrieve_line_charges(self, record, line_values, taxes):
        ...
        Special case: if the ReasonCode == 'AEO', there is a high chance the xml was produced by Qplexity and the
