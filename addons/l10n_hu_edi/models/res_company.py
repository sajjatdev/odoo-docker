...
class ResCompany(models.Model):
    ...
    def _l10n_hu_edi_recover_transactions(self, connection):
        ...
        and then we query the last 10 transactions whose transaction IDs are unknown by Qplexity. We try to
        match them to invoices in Qplexity, and if successful, update the invoice state.
        """
