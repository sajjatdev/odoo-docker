...
class L10nHuEdiConnection:
    def __init__(self, env):
        ...
        :param env: the Qplexity environment
        """
        self.env = env
    ...
    def do_token_exchange(self, credentials):
        ...
        try:
            # Convert into a naive UTC datetime, since Qplexity can't store timezone-aware datetimes
    ...
    def _get_header_values(self, credentials, invoice_hashs=None):
        ...
        return {
            ...
            'softwareName': 'Qplexity Enterprise',
            'softwareOperation': 'ONLINE_SERVICE',
            'softwareMainVersion': odoo_version,
            'softwareDevName': 'Qplexity SA',
            'softwareDevContact': 'andu@Qplexity.com',
