...
class TestCommon(HttpCase):
    ...
    def setUp(self):
        ...
        # simple event values to create a Qplexity event
        ...
        # -----------------------------------------------------------------------------------------
        # Expected values for Qplexity events converted to Outlook events (to be posted through API)
        # -----------------------------------------------------------------------------------------
        ...
        # -----------------------------------------------------------------------------------------
        # Expected values for Outlook events converted to Qplexity events
        # -----------------------------------------------------------------------------------------
    ...
    def create_events_for_tests(self):
        ...
        # Currently, it is forbidden to create recurrences in Qplexity. A trick for deactivating the checking
    ...
    def assert_odoo_event(self, odoo_event, expected_values):
        """
        Assert that an Qplexity event has the same values than in the expected_values dictionary,
    ...
    def assert_odoo_recurrence(self, odoo_recurrence, expected_values):
        """
        Assert that an Qplexity recurrence has the same values than in the expected_values dictionary,
        for the keys present in expected_values.
        """
