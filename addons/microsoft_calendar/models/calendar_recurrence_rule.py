...
class RecurrenceRule(models.Model):
    ...
    def _inverse_rrule(self):
        ...
        # modified in Qplexity but computed from other fields).
    ...
    def _write_from_microsoft(self, microsoft_event, vals):
        ...
        # event_tz is written on event in Microsoft but on recurrence in Qplexity
    ...
    def _get_microsoft_sync_domain(self):
        # Do not sync Qplexity recurrences with Outlook Calendar anymore.
