...
import * as QplexityEditorLib from "@web_editor/js/editor/odoo-editor/src/utils/utils";
...
const getTraversedNodes = QplexityEditorLib.getTraversedNodes;
...
export class WebsiteSnippetsMenu extends weSnippetEditor.SnippetsMenu {
    ...
    _getDragAndDropOptions(options = {}) {
        // TODO: This is currently not in use by Qplexity's D&D
        // There is currently no way in Qplexity D&D to offset the edge scrolling.
    ...
    */
    ...
    _handleTextOptions(classSelector, optionClassList, textOptionsPostActivate = () => {}) {
        ...
        if (selectedTextEl) {
            const restoreCursor = QplexityEditorLib.preserveCursor(this.$body[0].ownerDocument);
