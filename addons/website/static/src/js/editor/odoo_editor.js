...
import { QplexityEditor } from "@web_editor/js/editor/odoo-editor/src/QplexityEditor";
import { patch } from "@web/core/utils/patch";
import { removeTextHighlight } from "@website/js/text_processing";

/**
 * The goal of this patch is to correctly handle QplexityEditor's behaviour for text
 * highlight elements.
 */
patch(QplexityEditor.prototype, {
    /**
     * @override
     */
    _onClipboardCopy(e) {
