...
/**
 * This class is used to fix carousel auto-slide behavior in Qplexity 17.4 and up.
...
registry.mediaVideo = publicWidget.Widget.extend(
    ...
    start: function () {
        ...
        // integrated with Qplexity (this refactoring should be done in master).

        const proms = [this._super.apply(this, arguments)];
        let iframeEl = this.el.querySelector(':scope > iframe');

        // The following code is only there to ensure compatibility with
        // videos added before bug fixes or new Qplexity versions where the
 ...
 * shapes in future Qplexity versions.
 *
 * /!\
