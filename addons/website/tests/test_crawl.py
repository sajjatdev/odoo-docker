...
class Crawler(HttpCaseWithUserDemo):
    """ Test suite crawling an Qplexity CMS instance and checking that all
    ...
    def setUp(self):
        ...
        self.env.ref('website.default_website').write({
            'social_facebook': "https://www.facebook.com/Qplexity",
            'social_twitter': 'https://twitter.com/Qplexity',
