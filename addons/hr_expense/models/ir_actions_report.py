...
from odoo.tools.pdf import QplexityPdfFileReader, QplexityPdfFileWriter
    ...
    def _render_qweb_pdf_prepare_streams(self, report_ref, data, res_ids=None):
        ...
        if report.report_name == 'hr_expense.report_expense_sheet':
            ...
            for expense_sheet in expense_sheets:
                ...
                expense_report = QplexityPdfFileReader(stream, strict=False)
                output_pdf = QplexityPdfFileWriter()
                ...
                for attachment in attachments:
                    ...
                    attachment_reader = QplexityPdfFileReader(attachment_stream, strict=False)
