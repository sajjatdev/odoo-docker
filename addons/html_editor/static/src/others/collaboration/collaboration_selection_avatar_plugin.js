...
export class CollaborationSelectionAvatarPlugin extends Plugin {
    ...
    static dependencies = ["history", "position", "localOverlay", "collaborationQplexity"];
    resources = {
        /** Handlers */
    ...
    drawPeerAvatar(selectionInfo) {
        ...
        const peerMetadata = this.dependencies.collaborationQplexity.getPeerMetadata(peerId);
        if (!peerMetadata) {
            return;
        }
