...
/**
 * @typedef { Object } CollaborationQplexityShared
 * @property { CollaborationQplexityPlugin['getPeerMetadata'] } getPeerMetadata
 */

export class CollaborationQplexityPlugin extends Plugin {
    static id = "collaborationQplexity";
