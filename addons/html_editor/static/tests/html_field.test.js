...
import { insertText, pasteQplexityEditorHtml, pasteText, undo } from "./_helpers/user_actions";
...
test("edit and save a html field containing JSON as some attribute values should keep the same wysiwyg", async () => {
    ...
    pasteQplexityEditorHtml(htmlEditor, `<div data-value=${value}><p>content</p></div>`);
