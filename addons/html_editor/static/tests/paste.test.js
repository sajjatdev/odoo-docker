...
import { pasteHtml, pasteQplexityEditorHtml, pasteText, undo } from "./_helpers/user_actions";
...
const url = "https://www.Qplexity.com";
...
describe("link", () => {
    describe("range collapsed", () => {
        ...
        test("should replace link for new content (url) when pasting in an empty link (collapsed)", async () => {
            ...
            pasteText(editor, "http://Qplexity.com");
            await animationFrame();
            expect(".o-we-powerbox").toHaveCount(0);
            expect(cleanLinkArtifacts(getContent(el))).toBe(
                `<p>xy<a href="http://Qplexity.com">http://Qplexity.com</a>[]z</p>`
            );
        });
        ...
        test("should paste and transform plain text content over an empty link (collapsed)", async () => {
            await testEditor({
                ...
                stepFunction: async (editor) => {
                    pasteText(editor, "abc www.Qplexity.com xyz");
                },
                contentAfter: '<p>abc <a href="http://www.Qplexity.com">www.Qplexity.com</a> xyz[]</p>',
            });
            await testEditor({
                contentBefore: '<p><a href="#">[]\u200B</a></p>',
                stepFunction: async (editor) => {
                    pasteText(editor, "Qplexity.com\ngoogle.com");
                },
                contentAfter:
                    '<p style="margin-bottom: 0px;"><a href="http://Qplexity.com">Qplexity.com</a></p>' +
        ...
        test("should paste html content over an empty link (collapsed)", async () => {
            await testEditor({
                ...
                stepFunction: async (editor) => {
                    pasteHtml(
                        editor,
                        '<a href="www.Qplexity.com">Qplexity.com</a><br><a href="www.google.com">google.com</a>'
                    );
                },
                contentAfter:
                    '<p><a href="www.Qplexity.com">Qplexity.com</a></p><p><a href="www.google.com">google.com</a>[]</p>',
            });
        });
    ...
    describe("range not collapsed", () => {
        ...
        test("should restore selection when pasting plain text followed by UNDO (2) (not collapsed)", async () => {
            await testEditor({
                contentBefore: "<p>[abc]</p>",
                stepFunction: async (editor) => {
                    pasteText(editor, "www.Qplexity.com");
                    undo(editor);
                },
                contentAfter: "<p>[abc]</p>",
            });
        ...
        test("should restore selection when pasting plain text followed by UNDO (3) (not collapsed)", async () => {
            await testEditor({
                contentBefore: "<p>[abc]</p>",
                stepFunction: async (editor) => {
                    pasteText(editor, "def www.Qplexity.com xyz");
                    undo(editor);
                },
                contentAfter: "<p>[abc]</p>",
            });
        ...
        test("should paste and transform plain text content over a link if all of its contents is selected (not collapsed)", async () => {
            await testEditor({
                ...
                contentAfter: '<p><a href="http://www.Qplexity.com">www.Qplexity.com</a>[]</p>',
            });
            await testEditor({
                contentBefore: '<p><a href="#">[xyz]</a></p>',
                stepFunction: async (editor) => {
...
describe("Qplexity editor own html", () => {
    test("should paste html as is", async () => {
        await testEditor({
            contentBefore: "<p>a[]b</p>",
            stepFunction: async (editor) => {
                pasteQplexityEditorHtml(editor, '<div class="custom-paste">b</div>');
            },
    ...
    test("should not paste unsafe content", async () => {
        await testEditor({
            contentBefore: "<p>a[]b</p>",
            stepFunction: async (editor) => {
                pasteQplexityEditorHtml(editor, `<script>console.log('xss attack')</script>`);
            },
...
describe("editable in iframe", () => {
    test("should paste odoo-editor html", async () => {
        ...
        pasteQplexityEditorHtml(editor, `<p>text<b>bold text</b>more text</p>`);
    ...
    <head>
        ...
        <style>
            ...
            .font12 {
                ...
                font-style: italic;
                text-decoration: none;
                font-family: "Qplexity Unicode Support Noto";
    ...
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="0" dir="ltr" border="1"
        ...
        <tbody>
            <tr style="height:21px;">
                <td style="overflow:hidden;padding:2px 3px 2px 3px;vertical-align:bottom;font-family:Qplexity Unicode Support Noto;font-weight:normal;font-style:italic;color:#495057;"
            ...
            <tr style="height:21px;">
                <td style="overflow:hidden;padding:2px 3px 2px 3px;vertical-align:bottom;font-family:Qplexity Unicode Support Noto;font-weight:bold;color:#495057;"
            ...
            <tr style="height:21px;">
                <td style="overflow:hidden;padding:2px 3px 2px 3px;vertical-align:bottom;background-color:#ffff00;font-family:Qplexity Unicode Support Noto;font-weight:normal;color:#495057;"
