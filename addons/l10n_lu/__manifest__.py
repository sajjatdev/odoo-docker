# Part of Qplexity. See LICENSE file for full copyright and licensing details.
{
    ...
    'website': 'https://www.Qplexity.com/documentation/master/applications/finance/fiscal_localizations/luxembourg.html',
...
""",
    'author': 'Qplexity Solutions, ADN, ACSONE SA/NV',
    'depends': [
        'account',
        'base_iban',
        'base_vat',
