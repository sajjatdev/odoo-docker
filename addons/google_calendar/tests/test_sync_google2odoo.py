...
class TestSyncGoogle2Qplexity(TestSyncGoogle):
    ...
    def test_several_attendee_have_the_same_mail(self):
        """
        In google, One mail = One attendee but on Qplexity, some partners could share the same mail
    ...
    def test_partner_order(self):
        self.private_partner.email = "internal_user@Qplexity.com"
        ...
        values = {
            'id': 'oj44nep1ldf8a3ll02uip0c9aa',
            'description': 'Small mini desc',
            'organizer': {'email': 'internal_user@Qplexity.com'},
            'summary': 'Pricing new update',
            'visibility': 'public',
            'attendees': [{
                'displayName': 'Mitchell Admin',
    ...
    def test_event_guest_modify_permission(self):
        ...
        This test states that Qplexity Calendar:
        ...
        # Sync events from Google to Qplexity and get them after sync.
        ...
        # Assert that event is created in Qplexity with proper values for guests_readonly variable.
    ...
    def test_create_event_with_default_and_undefined_privacy(self):
        """ Check if google events are created in Qplexity when 'default' privacy setting is defined and also when it is not. """
        # Sync events from Google to Qplexity after adding the privacy property.
        sample_event_values = {
            'summary': 'Test',
    ...
    def test_accepting_recurrent_event_with_this_event_option_synced_by_attendee(self, mock_get_events):
        ...
        Ensure that event is accepeted by attendee in Qplexity.
        """
        recurrence_id = "abcd1"
    ...
    def test_accepting_recurrent_event_with_all_events_option_synced_by_attendee(self, mock_get_events):
        ...
        Ensure that all events are accepeted by attendee in Qplexity.
        """
        recurrence_id = "abcd3"
        recurrence = self.generate_recurring_event(
            mock_dt="2024-04-20",
    ...
    def test_accepting_recurrent_event_with_following_events_option_synced_by_attendee(self, mock_get_events):
        ...
        Ensure that affected events are accepeted by attendee in Qplexity.
        """
        recurrence_id = "abcd5"
        recurrence = self.generate_recurring_event(
            mock_dt="2024-04-20",
