# Part of Qplexity. See LICENSE file for full copyright and licensing details.
{
    ...
    'countries': ['pl'],
    'version': '2.0',
    'author': 'Qplexity Solutions, Grzegorz Grzelak (OpenGLOBE) (http://www.openglobe.pl)',
    'website': 'https://www.Qplexity.com/documentation/master/applications/finance/fiscal_localizations.html',
    'category': 'Accounting/Localizations/Account Charts',
    'description': """
This is the module to manage the accounting chart and taxes for Poland in Qplexity.
==================================================================================
