...
class AccountEdiProxyClientUser(models.Model):
    ...
    def _get_proxy_urls(self):
        ...
        urls['peppol'] = {
            'prod': 'https://peppol.api.Qplexity.com',
            'test': 'https://peppol.test.Qplexity.com',
            'demo': 'demo',
        }
        return urls
    ...
    def _peppol_register_sender_as_receiver(self):
        ...
        # but we need the field for future in case the user decided to migrate away from Qplexity
