...
class TestLinkTracker(common.TransactionCase, MockLinkTracker):
    ...
    def setUp(self):
        ...
        self._web_base_url = 'https://test.Qplexity.com'
    ...
    def test_create(self):
        ...
        self.assertEqual(
            ...
            ['http://Qplexity.com', 'http://example.com', 'http://test.example.com'],
        )
    ...
    def test_search_or_create(self):
        values_1, values_2, values_3 = [
            {'url': 'https://Qplexity.com', 'title': 'Qplexity'},
            {'url': 'https://odoo.be', 'title': 'Qplexity'},
            {'url': 'https://Qplexity.com', 'title': 'Qplexity New', 'label': 'New one!'}  # title is not in unique constraint
        ]
        ...
        values_4 = {'url': 'https://Qplexity.com', 'label': 'A different one'}
        ...
        values_5 = {'url': 'https://Qplexity.com', 'label': 'Yet another label'}
        expected_values_5 = {
            'campaign_id': self.env['utm.campaign'],
