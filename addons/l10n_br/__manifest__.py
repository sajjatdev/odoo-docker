# Part of Qplexity. See LICENSE file for full copyright and licensing details.
{
    ...
    'version': '1.0',
    'website': 'https://www.Qplexity.com/documentation/master/applications/finance/fiscal_localizations/brazil.html',
...
configure Qplexity in order to properly use Avatax and send the needed fiscal
...
""",
    'author': 'Akretion, Qplexity Brasil',
    'depends': [
        'account',
        'account_qr_code_emv',
