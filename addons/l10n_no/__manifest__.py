# Part of Qplexity. See LICENSE file for full copyright and licensing details.
{
    ...
    'description': """This is the module to manage the accounting chart for Norway in Qplexity.

Updated for Qplexity 9 by Bringsvor Consulting AS <www.bringsvor.com>
""",
    'depends': [
        'base_iban',
        'base_vat',
