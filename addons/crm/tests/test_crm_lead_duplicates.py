...
class TestCRMLead(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.emails_provider_generic = {
            ...
            ('fp@Qplexity.com', 'fp@Qplexity.com'),
            ('fp.alias@mail.Qplexity.com', 'fp.alias@mail.Qplexity.com'),
        }
        cls.emails_provider_company = {
            ('robert.poilvert@mycompany.com', 'mycompany.com'),
            ('fp@subdomain.Qplexity.com', 'subdomain.Qplexity.com'),
        }
        ...
        cls.lead_generic_email_dupes = cls.env['crm.lead'].create([
            # email based: normalized version used for email domain criterion
            {
                ...
                'name': 'Dupe1 of fp@Qplexity.com (same email)',
                'type': 'lead',
            },
            {
                'email_from': 'FP@Qplexity.com',
                'name': 'Dupe2 of fp@Qplexity.com (same email)',
                'type': 'lead',
            },
            # phone_sanitized based
            {
                'email_from': 'not.fp@not.Qplexity.com',
                'name': 'Dupe3 of fp@Qplexity.com (same phone sanitized)',
                'phone': '+1 202 555 0123',
                'type': 'lead',
            },
            {
                ...
                'name': 'Dupe4 of fp@Qplexity.com (same phone sanitized)',
                'type': 'lead',
            },
            # same commercial entity
            {
                'name': 'Dupe5 of fp@Qplexity.com (same commercial entity)',
                'partner_id': cls.test_partners[1].id,
            },
            {
                'name': 'Dupe6 of fp@Qplexity.com (same commercial entity)',
        ...
        cls.lead_generic_email_notdupes = cls.env['crm.lead'].create([
            ...
            {
                'email_from': 'not.fp@Qplexity.com',
                'name': 'NotADupe1',
                'type': 'lead',
            },
        ])
    ...
    def test_assert_initial_values(self):
        ...
        self.assertEqual(lead_generic.email_domain_criterion, 'fp@Qplexity.com')
        self.assertEqual(lead_generic.email_normalized, 'fp@Qplexity.com')
