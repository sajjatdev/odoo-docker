 ...
 * @typedef {import("@spreadsheet/helpers/model").QplexitySpreadsheetModel} QplexitySpreadsheetModel
 ...
 * @returns {Promise<QplexitySpreadsheetModel>}
 */
export async function createModelWithDataSource(params = {}) {
    ...
    const model = new Model(params.spreadsheetData, {
        ...
        custom: {
            env,
            odooDataProvider: new QplexityDataProvider(env),
            ...config?.custom,
        },
    });
