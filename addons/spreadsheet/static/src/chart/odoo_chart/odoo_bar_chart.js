...
export class QplexityBarChart extends QplexityChart {
...
chartRegistry.add("odoo_bar", {
    ...
    createChart: (definition, sheetId, getters) => new QplexityBarChart(definition, sheetId, getters),
    getChartRuntime: createQplexityChartRuntime,
    validateChartDefinition: (validator, definition) =>
        QplexityBarChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => QplexityBarChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () => QplexityBarChart.getDefinitionFromContextCreation(),
    name: _t("Bar"),
});
