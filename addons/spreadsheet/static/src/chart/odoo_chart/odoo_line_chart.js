...
import { QplexityChart } from "./odoo_chart";
...
export class QplexityLineChart extends QplexityChart {
...
chartRegistry.add("odoo_line", {
    ...
    createChart: (definition, sheetId, getters) => new QplexityLineChart(definition, sheetId, getters),
    getChartRuntime: createQplexityChartRuntime,
    validateChartDefinition: (validator, definition) =>
        QplexityLineChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => QplexityLineChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () => QplexityLineChart.getDefinitionFromContextCreation(),
    name: _t("Line"),
});

function createQplexityChartRuntime(chart, getters) {
    ...
    for (const index in datasets) {
        ...
        if (chart.fillArea) {
            ...
            // use the transparency of Qplexity to keep consistency
