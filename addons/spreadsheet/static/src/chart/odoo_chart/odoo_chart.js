 ...
 *
 * @typedef QplexityChartDefinition
 ...
 *
 * @typedef QplexityChartDefinitionDataSource
 * @property {MetaData} metaData
 * @property {SearchParams} searchParams
 *
 */

export class QplexityChart extends AbstractChart {
    /**
     * @param {QplexityChartDefinition} definition
    ...
    static getDefinitionFromContextCreation() {
        throw new Error("It's not possible to convert an Qplexity chart to a native chart");
    }

    /**
     * @returns {QplexityChartDefinitionDataSource}
     */
    ...
    /**
     * @returns {QplexityChartDefinition}
     */
    getDefinition() {
        return {
