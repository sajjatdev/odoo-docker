...
/**
 * @typedef {import("./odoo_data_provider").QplexityDataProvider} QplexityDataProvider
...
export class LoadableDataSource {
    /**
     * @param {Object} param0
     * @param {QplexityDataProvider} param0.odooDataProvider
     */
 ...
 * @param {string} model
 * @returns {Promise<import("@spreadsheet").QplexityFields>}
 */
