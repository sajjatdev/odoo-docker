...
/**
 * @typedef {import("@spreadsheet").QplexityField} QplexityField
 * @typedef {import("@spreadsheet").QplexityFields} QplexityFields
 */

/**
 * @typedef {Object} QplexityModelMetaData
 * @property {string} resModel
 * @property {QplexityFields} [fields]
 *
 * @typedef {Object} QplexityModelSearchParams
 * @property {Object} context
 * @property {Array<string>} domain
 */

export class QplexityViewsDataSource extends LoadableDataSource {
    /**
     * @override
     * @param {Object} services
     * @param {Object} params
     * @param {QplexityModelMetaData} params.metaData
     * @param {Object} params.searchParams
     */
    constructor(services, params) {
        super(services);
        /** @type {QplexityModelMetaData} */
    ...
    /**
     * @returns {QplexityFields} List of fields
     */
    getFields() {
     ...
     * @returns {QplexityField | undefined} Field
     */
    getField(field) {
        this._assertMetaDataLoaded();
