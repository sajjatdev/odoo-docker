...
export class ListUIPlugin extends QplexityUIPlugin {
     ...
     */
    _refreshQplexityLists() {
        for (const listId of this.getters.getListIds()) {
            this._refreshQplexityList(listId);
        }
    }
