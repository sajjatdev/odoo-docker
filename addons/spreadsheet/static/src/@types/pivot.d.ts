import { QplexityPivotRuntimeDefinition } from "@spreadsheet/pivot/pivot_runtime";
...
declare module "@spreadsheet" {
    ...
    export interface QplexityPivotCoreDefinition extends CommonPivotCoreDefinition {
        type: "ODOO";
        model: string;
        domain: Array;
        context: Object;
    ...
    export type ExtendedPivotCoreDefinition = PivotCoreDefinition | QplexityPivotCoreDefinition;

    interface QplexityPivot<T> extends Pivot<T> {
    ...
    export interface QplexityField {
        name: string;
        type: string;
        string: string;
        relation?: string;
    ...
    export type QplexityFields = Record<string, Field | undefined>;
    ...
    export interface QplexityPivotModelParams {
        fields: QplexityFields;
