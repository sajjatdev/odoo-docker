 ...
 * @param {Record<string, QplexityField | undefined>} allFields
 * @param {string} groupFieldString
 * @returns {{field: QplexityField, granularity: Granularity, isPositional: boolean, dimensionWithGranularity: string}}
 */
