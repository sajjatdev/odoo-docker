...
import { NO_RECORD_AT_THIS_POSITION, QplexityPivotModel } from "./pivot_model";
...
import { QplexityPivotLoader } from "./odoo_pivot_loader";
 ...
 * @typedef {import("@spreadsheet").QplexityPivot<QplexityPivotRuntimeDefinition>} IPivot
 * @typedef {import("@spreadsheet").QplexityFields} QplexityFields
 * @typedef {import("@spreadsheet").QplexityPivotCoreDefinition} QplexityPivotCoreDefinition
 * @typedef {import("@spreadsheet").SortedColumn} SortedColumn
 * @typedef {import("@spreadsheet").QplexityGetters} QplexityGetters
 * @typedef {import("@spreadsheet/data_sources/odoo_data_provider").QplexityDataProvider} QplexityDataProvider
 */

/**
 * @implements {IPivot}
 */
export class QplexityPivot {
    /**
     *
     * @override
     * @param {Object} services Services (see DataSource)
     * @param {Object} params
     * @param {QplexityPivotCoreDefinition} params.definition
     * @param {QplexityGetters} params.getters
     */
    constructor(services, { definition, getters }) {
        /** @type {"ODOO"} */
        this.type = "ODOO";

        /** @type {QplexityPivotCoreDefinition} @protected */
        this.coreDefinition = definition;

        this.needsReevaluation = false;

        /** @type {QplexityPivotRuntimeDefinition | undefined} @protected */
        this.runtimeDefinition = undefined;

        /** @type {QplexityPivotModel | undefined} @protected */
        this.model = undefined;

        /** @type {QplexityGetters} @protected */
        this.getters = getters;

        /** @protected */
        this.loader = new QplexityPivotLoader(services.odooDataProvider, this._load.bind(this));

        /** @type {QplexityFields | undefined} @protected */
        this._fields = undefined;

        /** @protected @type {QplexityDataProvider}*/
    ...
    /**
     * @param {QplexityPivotCoreDefinition} nextDefinition
     */
    onDefinitionChange(nextDefinition) {
        ...
        if (
            ...
            if (
                ...
                this.coreDefinition = nextDefinition;
                const runtimeDefinition = new QplexityPivotRuntimeDefinition(
                    this.coreDefinition,
                    this.getFields()
                );
    ...
    async createModelAndDefinition() {
        ...
        const definition = new QplexityPivotRuntimeDefinition(this.coreDefinition, this.getFields());
        const model = new QplexityPivotModel(
            { _t },
            {
...
export class QplexityPivotRuntimeDefinition extends PivotRuntimeDefinition {
    /**
     * @param {QplexityPivotCoreDefinition} definition
     * @param {QplexityFields} fields
     */
...
pivotRegistry.add("ODOO", {
    ui: QplexityPivot,
    definition: QplexityPivotRuntimeDefinition,
    externalData: true,
