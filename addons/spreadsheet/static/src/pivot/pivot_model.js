 ...
 */
export class QplexityPivotModel extends PivotModel {
    /**
     * @param {import("@web/env").QplexityEnv} env
     * @param {import("@spreadsheet").QplexityPivotModelParams} params
    ...
    /**
     * Get the Qplexity domain corresponding to the given domain
     * @param {PivotDomain} domain
     */
