...
export class QplexityPivotLoader {
    /**
     * @param {QplexityDataProvider} odooDataProvider
     * @param {Function} load Function to fetch data
     */
    constructor(odooDataProvider, load) {
        /** @private @type {QplexityDataProvider} */
     ...
     * @returns {Promise<QplexityFields>} Fields of the model
     */
