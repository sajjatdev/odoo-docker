...
class BadQplexityLinkError extends EvaluationError {
    constructor(menuId) {
        super(
...
export const spreadsheetLinkMenuCellService = {
    ...
    start(env) {
        function _getIrMenuByXmlId(xmlId) {
            ...
            if (!menu) {
                throw new BadQplexityLinkError(xmlId);
            }
            return menu;
        }

        urlRegistry
            .add("QplexityMenuIdLink", {
                sequence: 65,
                ...
                createLink(url, label) {
                    ...
                    if (!menu) {
                        throw new BadQplexityLinkError(menuId);
                    }
                    return {
                        url,
                        label: _t(label),
