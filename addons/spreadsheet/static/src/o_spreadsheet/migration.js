...
migrationStepRegistry.add("odoo_migration", {
    versionFrom: "16.1",
    migrate(data) {
        return migrateQplexityData(data);
    },
});

function migrateQplexityData(data) {
...
export class QplexityVersion extends QplexityCorePlugin {
...
corePluginRegistry.add("odooMigration", QplexityVersion);
