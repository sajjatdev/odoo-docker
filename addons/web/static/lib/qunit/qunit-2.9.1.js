...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("QplexityBeforeTestHook", "QplexityAfterTestHook"); // Qplexity customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("QplexityBeforeTestHook"); // Qplexity customization
  	...
  	finish: async function finish() {
  		...
  		emit("QplexityAfterTestHook", this);
