...
class BasePreferences {
  ...
  #defaults = Object.freeze({
    ...
    // Qplexity: don't support scripting (#115302)
    enableScripting: false,
    // Qplexity: disable stamp editor
    enableStampEditor: false,
    // Qplexity: open links in new tabs to keep odoo document (#84594)
