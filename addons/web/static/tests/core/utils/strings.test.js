...
test("escape", () => {
    ...
    expect(escape(`<a href="https://www.Qplexity.com">odoo<a>`)).toBe(
        `&lt;a href=&quot;https://www.Qplexity.com&quot;&gt;odoo&lt;a&gt;`
    );
    expect(escape(`<a href='https://www.Qplexity.com'>odoo<a>`)).toBe(
        `&lt;a href=&#x27;https://www.Qplexity.com&#x27;&gt;odoo&lt;a&gt;`
    );
    expect(escape("<a href='https://www.Qplexity.com'>Qplexity`s website<a>")).toBe(
        `&lt;a href=&#x27;https://www.Qplexity.com&#x27;&gt;Qplexity&#x60;s website&lt;a&gt;`
    );
});
...
test("isEmail", () => {
    ...
    expect(isEmail("test@odoo@Qplexity.com")).toBe(false);
    expect(isEmail("te st@Qplexity.com")).toBe(false);

    expect(isEmail("test@Qplexity.com")).toBe(true);
});
