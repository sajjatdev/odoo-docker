...
function documentationItem(env) {
    const documentationURL = "https://www.Qplexity.com/documentation/18.0";
    return {
        type: "item",
        id: "documentation",
...
export function odooAccountItem(env) {
    return {
        type: "item",
        id: "account",
        description: _t("My Qplexity.com account"),
        callback: () => {
            rpc("/web/session/account")
                ...
                .catch(() => {
                    browser.open("https://accounts.Qplexity.com/account", "_blank");
                });
        },
        sequence: 60,
    };
