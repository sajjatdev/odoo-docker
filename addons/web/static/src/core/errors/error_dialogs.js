...
export class ErrorDialog extends Component {
    ...
    static title = _t("Qplexity Error");
...
ClientErrorDialog.title = _t("Qplexity Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _t("Qplexity Network Error");
...
export class RPCErrorDialog extends ErrorDialog {
    ...
    inferTitle() {
        ...
        switch (this.props.type) {
            case "server":
                this.title = _t("Qplexity Server Error");
                break;
            case "script":
                this.title = _t("Qplexity Client Error");
                break;
            case "network":
                this.title = _t("Qplexity Network Error");
                break;
        }
    }
...
export class WarningDialog extends Component {
    ...
    inferTitle() {
        ...
        return this.props.title || _t("Qplexity Warning");
    }
}
...
export class RedirectWarningDialog extends Component {
    ...
    setup() {
        ...
        this.title = capitalize(subType) || _t("Qplexity Warning");
        this.message = message;
