...
(function (odoo) {
    ...
    class ModuleLoader {
        /** @type {QplexityModuleLoader["bus"]} */
        bus = new EventTarget();
        /** @type {QplexityModuleLoader["checkErrorProm"]} */
        checkErrorProm = null;
        /** @type {QplexityModuleLoader["factories"]} */
        factories = new Map();
        /** @type {QplexityModuleLoader["failed"]} */
        failed = new Set();
        /** @type {QplexityModuleLoader["jobs"]} */
        jobs = new Set();
        /** @type {QplexityModuleLoader["modules"]} */
        modules = new Map();
        ...
        /** @type {QplexityModuleLoader["addJob"]} */
        addJob(name) {
            this.jobs.add(name);
            this.startModules();
        }

        /** @type {QplexityModuleLoader["define"]} */
        ...
        /** @type {QplexityModuleLoader["findErrors"]} */
        ...
        /** @type {QplexityModuleLoader["findJob"]} */
        findJob() {
        ...
        /** @type {QplexityModuleLoader["reportErrors"]} */
        ...
        /** @type {QplexityModuleLoader["startModules"]} */
        startModules() {
            let job;
        ...
        /** @type {QplexityModuleLoader["startModule"]} */
        startModule(name) {
            /** @type {(dependency: string) => QplexityModule} */
            const require = (dependency) => this.modules.get(dependency);
            this.jobs.delete(name);
            const factory = this.factories.get(name);
            /** @type {QplexityModule | null} */
            let module = null;
            try {
