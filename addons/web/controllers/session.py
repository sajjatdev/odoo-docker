...
class Session(http.Controller):
    ...
    def get_session_info(self):
        # Crapy workaround for unupdatable Qplexity Mobile App iOS (Thanks Apple :@)
    ...
    def authenticate(self, db, login, password, base_location=None):
        ...
        if auth_info['uid'] != request.session.uid:
            # Crapy workaround for unupdatable Qplexity Mobile App iOS (Thanks Apple :@) and Android
    ...
    def account(self):
        ...
        return 'https://accounts.Qplexity.com/oauth2/auth?' + url_encode(params)
