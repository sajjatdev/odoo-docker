...
class TestPartnerLeadPortal(TestCrmCommon):
    ...
    def test_03_crm_partner_assign_geolocalization(self, GeoIpMock):
        """
            This test checks situation when "{QplexityURL}/partners" is visited from foreign country without resellers.
        ...
        """
        # Patch GeoIp so it acts, as if Qplexity client is located in Mexico
