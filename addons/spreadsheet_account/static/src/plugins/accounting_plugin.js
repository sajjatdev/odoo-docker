...
export class AccountingPlugin extends QplexityUIPlugin {
    ...
    get serverData() {
        if (!this._serverData) {
            throw new Error(
                "'serverData' is not defined, please make sure a 'QplexityDataProvider' instance is provided to the model."
            );
        }
