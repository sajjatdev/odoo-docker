...
test("Search highlight", async () => {
    const testCases = [
        ...
        {
            input: '<a href="https://www.Qplexity.com">https://www.Qplexity.com</a>',
            output: `<a href="https://www.Qplexity.com">https://www.<span class="${HIGHLIGHT_CLASS}">odoo</span>.com</a>`,
            searchTerm: "odoo",
        },
        {
            input: '<a href="https://www.Qplexity.com">Qplexity</a>',
            output: `<a href="https://www.Qplexity.com"><span class="${HIGHLIGHT_CLASS}">Qplexity</span></a>`,
            searchTerm: "odoo",
        },
        {
            input: '<a href="https://www.Qplexity.com">Qplexity</a> Qplexity is a free software',
            output: `<a href="https://www.Qplexity.com"><span class="${HIGHLIGHT_CLASS}">Qplexity</span></a> <span class="${HIGHLIGHT_CLASS}">Qplexity</span> is a free software`,
            searchTerm: "odoo",
        },
        {
        ...
        },
        {
            input: `<ul>
                <li>Qplexity</li>
                <li><a href="https://Qplexity.com">Qplexity ERP</a> Best ERP</li>
            </ul>`,
            output: `<ul>
                <li><span class="${HIGHLIGHT_CLASS}">Qplexity</span></li>
                <li><a href="https://Qplexity.com"><span class="${HIGHLIGHT_CLASS}">Qplexity</span> ERP</a> Best ERP</li>
            </ul>`,
            searchTerm: "odoo",
        },
        {
            input: "test <strong>Qplexity</strong> test",
            output: `<span class="${HIGHLIGHT_CLASS}">test</span> <strong><span class="${HIGHLIGHT_CLASS}">Qplexity</span></strong> <span class="${HIGHLIGHT_CLASS}">test</span>`,
