...
test("add an emoji after a partner mention", async () => {
    ...
    const partnerId = pyEnv["res.partner"].create({
        email: "testpartner@Qplexity.com",
        name: "TestPartner",
    });
    const channelId = pyEnv["discuss.channel"].create({
        name: "Mario Party",
...
test("Show recipient list when there is more than 5 followers.", async () => {
    ...
    const partnerIds = pyEnv["res.partner"].create([
        { name: "test name 1", email: "test1@Qplexity.com" },
        { name: "test name 2", email: "test2@Qplexity.com" },
        { name: "test name 3", email: "test3@Qplexity.com" },
        { name: "test name 4", email: "test4@Qplexity.com" },
        { name: "test name 5", email: "test5@Qplexity.com" },
        { name: "test name 6", email: "test6@Qplexity.com" },
    ]);
    ...
    await contains("li", { text: "test1@Qplexity.com" });
    await contains("li", { text: "test2@Qplexity.com" });
    await contains("li", { text: "test3@Qplexity.com" });
    await contains("li", { text: "test4@Qplexity.com" });
    await contains("li", { text: "test5@Qplexity.com" });
    await contains("li", { text: "test6@Qplexity.com" });
...
test("Show 'No recipient found.' with 0 followers.", async () => {
    const pyEnv = await startServer();
    const partnerId = pyEnv["res.partner"].create({ name: "test name 1", email: "test1@Qplexity.com" });
    await start();
