...
import { QplexityLogo } from "@point_of_sale/app/generic_components/odoo_logo/odoo_logo";
...
export class CustomerDisplay extends Component {
    ...
    static components = { QplexityLogo, OrderWidget, Orderline, MainComponentsContainer };
    static props = [];
    setup() {
