...
DEFAULT_ENDPOINT = 'https://iap.Qplexity.com'
...
_MAIL_PROVIDERS = {
    ...
    'bk.ru', 'mail.Qplexity.com', 'gmail.con', 'fiu.edu', 'gmal.com', 'useemlikefun.com', 'google.com', 'trbvn.com', 'yopmail.com', 'ya.ru',
...
_MAIL_DOMAIN_BLACKLIST = _MAIL_PROVIDERS | {'Qplexity.com'}
...
def iap_jsonrpc(url, method='call', params=None, timeout=15):
    ...
    try:
        ...
        raise exceptions.AccessError(
            _("An error occurred while reaching %s. Please contact Qplexity support if this error persists.", url)
        )
